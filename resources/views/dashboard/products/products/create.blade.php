        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-colored-form-control">{{ __('static.products.create_product') }}
                    </h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        @livewire('dashboard.create-product', ['categories' => $categories, 'brands' => $brands, 'productAttributes' => $productAttributes])
                    </div>
                </div>
            </div>
        </div>
