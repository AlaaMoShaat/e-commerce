                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $role->getTranslation('role', 'en') }}" type="text"
                                                id="role_name_en" class="form-control border-primary"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $role->getTranslation('role', 'ar') }}" type="text"
                                                id="role_name_ar" class="form-control border-primary"
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <fieldset>
                                                        ...
                                                        <label
                                                            for="select-all">{{ __('static.global.select_all') }}</label>
                                                    </fieldset>
                                                    <div class="row skin skin-line">
                                                        @foreach (__('permessions') as $permessionKey => $permession)
                                                            <div class="col-3">
                                                                <fieldset>
                                                                    <input @checked(in_array($permessionKey, $role->permession))
                                                                        class="permession-checkbox"
