                    ...
                    @if ($msg)
                        ...
                        <div class="email-app-options card-body d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <button
                                    @if ($msg->deleted_at != null) wire:click="forceDeleteContact({{ $msg->id }})" @else wire:click="deleteMsg({{ $msg->id }})" @endif
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" wire:click="markAsUnRead({{ $msg->id }})"
