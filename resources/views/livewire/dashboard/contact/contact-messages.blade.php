...
<div class="email-app-list">
    ...
    <div class="list-group">
        @forelse ($messages as $msg)
            <a wire:click="showMessage({{ $msg->id }})" href="#"
                class="media mb-2 border-0 {{ $msg->id == $opendMsgId ? 'bg-light' : '' }}">
                ...
                <div class="media-body w-100">
                    ...
                    <p class="mb-0 text-muted">{{ Str::limit($msg->message, 50) }}
                        <span class="float-right">
                            <span
                                class="badge badge-{{ $msg->is_read ? 'success' : 'danger' }}">{{ $msg->is_read ? 'Read' : 'New' }}</span>
                        </span>
                    </p>
                </div>
            </a>
